...
def double_echo(sound1,sound2,delay,sample_length):
    values=[]
    for i in range(0,sample_length):
        values.append(sound1[i])
        if i>delay:
...
Double_echo_values=echo(tone_values_one,tone_values_two,40000,132000)
...
save_wave_file('Double_Echo.wav',Double_echo_values, SAMPLE_RATE)
